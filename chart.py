...
def draw_Histogram():
    ...
    rec2 = plt.bar(index + bar_width, Y2, bar_width, alpha=opacity, facecolor='yellowgreen', edgecolor='white',
                   label='data2')
    rec3 = plt.bar(index + bar_width * 2, Y3, bar_width, alpha=opacity, facecolor='grey', edgecolor='white',
                   label='data3')
    rec4 = plt.bar(index + bar_width * 3, Y4, bar_width, alpha=opacity, facecolor='red', edgecolor='white',
                   label='data4')
